...
export default function FoodDetailPage({
  ...
  // Next.js 16: params là Promise nên phải dùng React.use()
  const { id } = use(params);
  ...
  if (!food) {
    return <div className={styles.page}>❌ {t("not_found")}</div>;
  }
    ...
    >
      ...
      >
        ...
        <div className={styles.content}>
          ...
          >
            <FaUtensils size={18} color="#b30000" />
            {t("suggested_sides")}
          </h3>
          ...
          >
            ...
            {t("community_reviews")} ({virtualReviews.length})
          </h3>
            ...
            <div key={i} className={styles.commentBox}>
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  ...
                  <span
                    className={`${styles.roleTag} ${rev.tag}`}
                  >
                    {rev.role}
                  </span>
                </div>
